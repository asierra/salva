class CourseInstructorsController < PublicationController
  ...
  def course_params
    params.require(:course).permit(:name, :courseduration_id, :modality_id, :hoursxweek,
     :totalhours, :startyear, :startmonth, :endyear, :endmonth, :country_id, :location,
      user_courses_attributes: [:user_id, :roleincourse_id])
  end
end
